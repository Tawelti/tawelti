...
const ChichaSeller = () => {
  ...
  const fetch = () => {
    axios.get("http://192.168.169.127:3000/api/Product/getAll//Chicha") 
    .then(res => {
      setData(res.data)
    })
    .catch(err => {
...
const AddProduct = (productname , price , Immage) => {
  axios.post('http://192.168.234.127:3000/api/Product/create/1/Chicha', {
...
return (
  ...
  />
   <TouchableOpacity style={styles.addButton} onPress={AddProduct}>
        <Text style={styles.addButtonLabel} onPress={openDialog}>Add New Product</Text>
      </TouchableOpacity>
